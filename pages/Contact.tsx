...
const Contact: React.FC = () => {
    ...
    return (
        <div className="relative py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
            <SEO
                title="Contact Aadhava Attan - Order Authentic Indian Snacks Online | Worldwide Delivery"
                description="Contact Aadhava for bulk orders, export inquiries, and authentic South Indian snacks. We ship to India, Singapore, Canada and more. Email us for Murukku, Mixture, and traditional sweets."
            ...
            <div className="bg-[#F8E9C9] border-y-4 border-[#7A0F12] py-12 text-center mb-16 relative">
                ...
                <h1 className="text-4xl sm:text-5xl font-serif font-bold text-[#0F5A2A] mb-4">Order Authentic Indian Snacks Online - Contact Aadhava</h1>
                <p className="text-xl text-[#7A0F12] font-serif">Worldwide Delivery to India, Singapore, Canada & More</p>
            </div>
