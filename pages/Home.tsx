...
const Home: React.FC = () => {
  return (
    <div className="relative">
      ...
      <section className="relative w-full bg-[#F8E9C9] px-0 overflow-hidden flex flex-col justify-center items-center pt-16 pb-16">
         {/* Background pattern overlay */}
        <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/paisley.png')] pointer-events-none"></div>
      ...
      <section className=" px-4 max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {PRODUCTS.map((product) => (
                <div key={product.id} className="group relative bg-[#F8E9C9] rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border-4 border-[#7A0F12]">
                    ...
                    <div className="p-8 flex flex-col items-center text-center h-full justify-between bg-[url('https://www.transparenttextures.com/patterns/white-diamond.png')]">
                        ...
                        <div className="mt-6 w-full border-t border-[#7A0F12]/30 pt-4 flex justify-between items-center text-xs font-bold text-[#7A0F12]">
