...
const About: React.FC = () => {
  return (
    <div className="relative py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto z-10">
      <SEO
        title="About Aadhava Attan - Handmade Traditional South Indian Snacks Since 2023"
        description="Discover the story behind Aadhava Attan - authentic South Indian snacks made with grandmother's recipes. No palm oil, no preservatives. Handcrafted with love in Tamil Nadu."
        canonicalUrl="/about"
      />
      ...
      <div className="text-center mb-16">
        <div className="inline-block border-b-4 border-[#7A0F12] pb-2 mb-4">
          <h1 className="text-4xl sm:text-5xl font-serif font-bold text-[#7A0F12]">Our Story - Traditional Handmade Indian Snacks</h1>
        </div>
        <p className="text-xl text-[#0F5A2A] font-serif italic">The Authentic Journey of Aadhava - Preservative-Free Snacks Since 2023</p>
      </div>
