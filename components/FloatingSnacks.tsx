...
const SnackShapes = {
  Mixture: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke={COLORS.gold} strokeWidth="2" className="w-full h-full">
  ...
  Stick: () => (
    <svg viewBox="0 0 24 24" fill="none" stroke={COLORS.gold} strokeWidth="3" className="w-full h-full">
...
const FloatingSnacks: React.FC = () => {
  ...
  const snacks = Array.from({ length: 10 }).map((_, i) => {
